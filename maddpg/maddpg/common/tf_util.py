...
def load_state(fname, saver=None):
    ...
    genpathmodel = os.path.join(fname, os.path.basename(ckpt.model_checkpoint_path))
    print('GEEEN PATH MODEEELL:', genpathmodel)
    saver.restore(get_session(), genpathmodel)
    return saver
